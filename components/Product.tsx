    ...
    <ResultContainer>
      ...
      <Divs>
        ...
        <Paragraph>
          ...
          {props.hit.data_job.job_type} <ColoredText>Title:</ColoredText>
          {props.hit.data_job.job_title} <ColoredText>Wage:</ColoredText>
          {props.hit.data_job.job_wage_currency}
          {props.hit.data_job.job_wage}/{props.hit.data_job.job_wage_type}{" "}
          <ColoredText>Views:</ColoredText>
          {props.hit.data_job.job_views} <ColoredText>Location:</ColoredText>
          {props.hit.data_location.location_address_1},
          {props.hit.data_location.location_country}{" "}
        </Paragraph>
      </Divs>
      <Divs>
